        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h1 class="mt-20">Daftar Alternatif</h1>
                    ...
                    <table class="table table-hover w-100"> <!-- Changed class here -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ $alternative->label }}</td>
                                <td class="align-middle">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('/alternatives/edit', ['id'=>$alternative->id]) }}" type="button" class="btn btn-secondary">Edit</a>
                                        <a href="{{ route('/alternatives/delete', ['id'=>$alternative->id]) }}" type="button" class="btn btn-danger">Hapus</a>
                                    </div>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td class="text-center" colspan="8">Alternative Tidak Ada</td> <!-- Changed colspan here -->
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
